...
dubbo-servicecomb 为 dubbo 开发的微服务应用，提供注册中心、配置中心、服务治理支持，方便 dubbo 应用使用
...
| ---  | ------- | ------------ | ----------- |
| 2.6.x | 1.1.1 | 2.6.9 | 2.6.x，建议使用前先升级到 2.6.9 以上的版本|
| 2.6.x | 1.1.2-SNAPSHOT | 2.6.9 | 2.6.x，建议使用前先升级到 2.6.9 及以上的版本|
| master | 1.3.1 | 2.7.8 | 2.7.x，建议使用前先升级到 2.7.8 及以上的版本|
| master | 1.3.2-SNAPSHOT | 2.7.8 | 2.7.x，建议使用前先升级到 2.7.8 及以上的版本|
