...
| ---  | ------- | ------------ | ----------- |
| 2.6.x | 1.1.2 | 2.6.9 | 2.6.x，建议使用前先升级到 2.6.9 以上的版本|
| 2.6.x | 1.1.3-SNAPSHOT | 2.6.9 | 2.6.x，建议使用前先升级到 2.6.9 及以上的版本|
| master | 1.3.2 | 2.7.8 | 2.7.x，建议使用前先升级到 2.7.8 及以上的版本|
| master | 1.3.3-SNAPSHOT | 2.7.8 | 2.7.x，建议使用前先升级到 2.7.8 及以上的版本|
