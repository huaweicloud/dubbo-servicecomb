...
| master | 1.3.6 | 2.7.8 | 2.7.x，建议使用前先升级到 2.7.8 及以上的版本|
| master | 1.3.7-SNAPSHOT | 2.7.8 | 2.7.x，建议使用前先升级到 2.7.8 及以上的版本|
...
```yaml
dubbo.servicecomb.governance: {"providerInfos":[{"serviceName":"price-provider","schemaInfos":[{"schemaId":"com.huawei.it.price.PriceService","parameters":{"timeout":5000}}]}]}
```
