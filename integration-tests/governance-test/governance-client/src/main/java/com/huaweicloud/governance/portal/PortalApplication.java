...
package com.huaweicloud.governance.portal;
...
public class PortalApplication {
  private static PortalControllerRest portalController;
  ...
  @Autowired
  void setPortalController(PortalControllerRest portalController) {
